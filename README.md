...
1. Create user and password with htpasswd, and provide cluster-admin to it - view comments in [prerequisites/1-user_management/1-htpasswd-secret.yaml](prerequisites/1-user_management/1-htpasswd-secret.yaml), edit, then apply:
